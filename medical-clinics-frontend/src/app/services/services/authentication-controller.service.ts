...
export class AuthenticationControllerService extends BaseService {
  ...
  /**
   * Login user in our system (send authorization token).
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  login$Response(params: Login$Params, context?: HttpContext): Observable<StrictHttpResponse<UserDataResponse>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  login(params: Login$Params, context?: HttpContext): Observable<UserDataResponse> {
    return this.login$Response(params, context).pipe(
      map((r: StrictHttpResponse<UserDataResponse>): UserDataResponse => r.body)
    );
  }
